...
async function main() {
    ...
    const myOAppAddressRemote = '0xC592c7bB3b664B9E093d62B8Efd429b1B2EF21D1'

    const myOAppAddressLocal = '0xd842f6bF30E5DA6FcDBE17E7b769969DB556cD36'

    // Get the contract factory for MyOApp
    const MyOAppLocal = await ethers.getContractFactory('VerifiedAirdrop', deployer)
